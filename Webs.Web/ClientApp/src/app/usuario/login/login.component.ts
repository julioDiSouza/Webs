...
export class LoginComponent implements OnInit {
  ...
  entrar() {
    ...
    //if (this.usuario.email == "julio@teste" && this.usuario.senha == "123") {
    //  sessionStorage.setItem("usuario-autenticado", "1");
    //  this.router.navigate([this.returnUrl]);
    //}
  }
